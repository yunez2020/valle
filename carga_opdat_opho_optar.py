...
engine2 = create_engine('mysql+mysqlconnector://admin:Efts2020@valle.mysql.simplermp.com:3306/valle_lastview', echo=False)

engine = create_engine('mssql+pyodbc://art2fly:Art2Fly_.,@200.29.187.26:1433/SQLFRONT_ART2FLY?driver=SQL+Server+Native+Client+11.0', echo=False)
...
df = pd.read_sql_query('''select * from dbo.opdat where left([DFECREA],4) in ('2019', '2020', '2021');''', engine)
...
df1.to_sql(name='ophfo', con=engine2, if_exists = 'replace', index=False,chunksize=100)
