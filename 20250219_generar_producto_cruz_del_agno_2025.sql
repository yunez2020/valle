...
WHERE id_fecha_vista_ay>='20241101' AND id_fecha_vista_ay<='20251017';

DROP TABLE IF EXISTS aux_semana_temp;
CREATE TABLE aux_semana_temp 
SELECT fecha_uso, semana_temp 
FROM semanas
WHERE dia_semana=5 AND semana_temp>0 AND semana_temp<=17 AND substring(fecha_uso,1,4)='2025';
