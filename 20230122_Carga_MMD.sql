...
SELECT 2023 AS id_anho_ppto, h.id_hotel, p.semana_temp, th.id_tipo_habitacion, nt.id_nivel_tarifa, n.id_pos,
...
ON fp.id_anho_ppto = 2023 AND fp.id_hotel = h.id_hotel AND fp.id_semana_temp = p.semana_temp AND fp.id_tipo_habitacion = th.id_tipo_habitacion
...
ON rcly.id_fecha_vista = pv.id_fecha_vista_ly AND rcly.id_anho_uso = a.id_anho - 1 AND rcly.id_pos = pv.id_pos AND rcly.id_hotel = pv.id_hotel 
...
ON ly.id_anho_uso = a.id_anho -1 AND ly.id_pos = pv.id_pos AND ly.id_hotel = pv.id_hotel AND ly.id_tipo_habitacion = pv.id_tipo_habitacion AND ly.id_nivel_tarifa = pv.id_nivel_tarifa AND ly.id_semana_temp = pv.id_semana_temp
...
delete from ft_overview where id_anho_uso<>'2023';
...
update ft_overview set id_anho_uso='2023' where id_vista in ('Y2018');
